    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="scripts/register.php" method="post" enctype="multipart/form-data">
                ...
                <option value="mobile">carpenter</option>
                <option value="mobile">homedecor</option>
                <option value="mobile">event management</option>
                <option value="mobile">Lab technician</option>
                <option value="mobile">painters</option>
                <option value="mobile"> repair service</option>
